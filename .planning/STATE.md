...
| 2026-08-29 | fast | Kanban do /pipeline cabe as 5 colunas na tela sem rolar pro lado: colunas flex-1 min-w-[200px] + gap-3, cards com nome break-words e linha de badges flex-wrap, <main> com min-w-0. Verificado no navegador (5 colunas visíveis, 0 scroll horizontal). | ✅ 5b52ffa |
