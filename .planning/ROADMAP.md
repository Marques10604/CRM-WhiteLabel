...
- [ ] 04-01-PLAN.md — Corte vertical do dashboard de follow-ups: / vira painel por urgência, lista move p/ /leads, nav 6 itens (REMIND-01)
- [ ] 04-02-PLAN.md — Sistema de templates de WhatsApp: tabela templates + push + CRUD /templates + padrão-por-tipo (WA-01)
- [ ] 04-03-PLAN.md — Envio inline: whatsapp.ts (wa.me) + botão + modal de preview no dashboard e no pipeline (WA-02, WA-03, WA-05)
...
| 4. Follow-up Dashboard & WhatsApp Outreach | 0/4 | Not started | - |
