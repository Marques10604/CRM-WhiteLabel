...
| 004 | sidebar-brand-header | Qual tratamento tipográfico pro texto "CRM Leads" no topo da sidebar (peso/tamanho/tracking)? | C (selo discreto, uppercase, estilo Notion/Attio) | [sidebar, typography, brand] |
